...
export function MobileNav() {
  ...
  return (
    <>
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-background/95 backdrop-blur-2xl supports-backdrop-filter:bg-background/60 pb-[env(safe-area-inset-bottom)]">
